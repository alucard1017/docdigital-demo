...
const ROLE_OPTIONS = [
  ...
  { value: "ADMIN_GLOBAL", label: "ADMIN_GLOBAL" },
    ...
    return (
      <div style={{ padding: 24 }}>
        <p style={{ fontSize: "0.9rem", color: "#64748b" }}>
          Cargando logs de autenticación...
        </p>
      </div>
    );
  }
    ...
    <div className="card-premium">
      ...
      >
        <div>
          ...
          <p style={{ margin: 0, fontSize: "0.85rem", color: "#64748b" }}>
            Historial de logins con filtros por acción, RUN, rol y empresa.
          </p>
        </div>
      ...
      {logsPaginados.length === 0 ? (
        ...
        >
          ...
          >
            No hay eventos de autenticación que coincidan con los filtros.
          </p>
          <p style={{ margin: 0, fontSize: "0.85rem", color: "#64748b" }}>
            Prueba ajustando los filtros o espera nuevos logins.
          </p>
        </div>
      ) : (
        <>
            ...
            <table className="doc-table">
              <thead>
                <tr>
                  ...
                  <th style={{ textAlign: "center", width: 120 }}>IP</th>
